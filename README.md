# Travlr :airplane:
   Travlr is your photo companion when you travel. The app allows you to share your photos instantly for all users to see on the feed page. Interactivity through posts include, CRUD image functionality and CRUD comment functionality. You can check out a users profile and see all their posts! Check out the live app: [Travlr](travlr-react.herokuapp.com)
...
# Components 
## Landing
   - Landing uses keyframes for CSS slideshow and modals for Login and Signup Ccomponents. 
## Feed
